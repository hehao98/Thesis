...
\begin{figure}[t]
    ...
    One residual threat remains that the design does not absorb---time-varying adoption of automated dependency-update tools.
...
The main residual threat that the design does not fully absorb is time-varying tool adoption.
...
This is time-varying within projects and is not fully absorbed by project fixed effects.
