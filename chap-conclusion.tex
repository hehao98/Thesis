...
This framework builds on top of the existing diverse realm of empirical methods used in SE and adds an explicit statement of the causal theory, estimand, and assumptions that would help transparent disclosure and iterative refinement.
\end{itemize}
