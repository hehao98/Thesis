...
\begin{summary-rq}
\textbf{Causal credibility, in plain language:} The fake-stars study has a relatively weak causal design among the three empirical chapters in this thesis because the maintainer's purchase decision is endogenous and three load-bearing assumptions all require empirical argument; nonetheless, the chapter's policy recommendation against buying fake stars survives because the residual biases on the short-run estimate point upward---the headline recommendation in this paper ``buying fake stars is ineffective'' is still strong and credible despite the limitations.
\end{summary-rq}
