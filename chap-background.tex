...
Consider what designs are feasible given the setting: Is randomization possible? Is there a natural experiment? What data are available?
Choose the strongest design that is credible in the specific research context rather than forcing an inappropriate method with theoretically stronger causal validity.
...
Since identifying assumptions is untestable, explore how conclusions change if assumptions are violated.
...
Consider the following hypothetical example: Should an organization adopt a new static analysis tool?
...
The credibility of causal claims ultimately rests on transparently examining their plausibility, demonstrating robustness to reasonable violations, and honestly communicating what the evidence can and cannot tell about the problem at hand.
