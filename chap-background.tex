...
\paragraph{Application in Software Engineering.}
While still not common in software engineering research, DiD designs are potentially well-suited to a family of empirical software engineering problems on the effects of tool adoption, policy changes, or platform updates in software development.
...
These studies demonstrate that DiD is broadly applicable to achieve credible causal inference in software engineering contexts, provided that natural variation in adoption timing creates quasi-experimental conditions.
...
Angrist and Lavy's 1999 study of class-size effects, exploiting a maximum class-size rule, exemplifies the modern application of RDD in the social sciences.
