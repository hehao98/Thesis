...
As argued in the thesis statement, causal credibility assessments are feasible in empirical software engineering through an explicit articulation of causal theory and assumptions.
...
In practice, software engineering papers that engage with causal reasoning typically embed their theoretical assumptions in textual discussions---describing potential confounders in prose, acknowledging threats to validity, and arguing informally about causal pathways.
...
This visual explicitness opens the assumptions to scrutiny in a way that prose alone cannot.
...
Even in these settings, however, a partial DAG can help clarify which confounders the design does and does not address, and what alternative explanations remain plausible.
...
In the language-defect setting, the causal estimate of interest might be the ATE of adopting a statically-typed language with respect to defect density.
