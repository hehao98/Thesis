...
This is the sense in which the four-step process demonstrated in this thesis calls for researchers to ``make the causal theory explicit'' and to ``thoughtfully navigate alternative explanations (i.e., alternative causal structures) that may also be supported with current results.''
...
With the causal theory articulated, the researcher defines the causal quantity of interest using the potential outcomes framework (Section~\ref{sec:formalism}).
