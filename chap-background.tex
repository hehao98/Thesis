...
This is the sense in which the four-step process demonstrated in this thesis calls for researchers to ``make the causal theory explicit as DAGs'' and to ``thoughtfully navigate alternative explanations (i.e., alternative DAGs) that may also be supported with current results.''
...
Crucially, the plausibility of a causal DAG rests on \emph{domain knowledge}~\cite{pearl2009causality}, and in software engineering, this is largely captured in the prior literature, especially descriptive and qualitative research.
