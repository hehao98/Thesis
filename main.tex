...
\usepackage[backend=biber, style=numeric, maxbibnames=999]{biblatex}\let\citet\textcite\let\citep\parencite
...
% \TODO notes are not shown by default in a Thesis document to suppress TODOs in a WIP tutorial paper.
\newif\ifshowtodos
\showtodosfalse
