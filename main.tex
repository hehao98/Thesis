...
Unfortunately, empirical software engineering research often fails to rigorously test these beliefs when it relies on descriptive, correlational, and qualitative evidence without explicitly assessing the extent to which it supports a causal theory of interest.
...
Across three empirical studies, I demonstrate how explicit causal credibility assessments can reveal systematic gaps between practitioner beliefs and empirical reality. 
...
In each study, I assess the credibility of causal claims through the following four-step framework: (1) articulating the causal theory of interest, (2) discussing the assumptions under which the statistical model estimates would carry a causal interpretation, (3) honestly acknowledging and mitigating limitations, and (4) carefully navigating alternative explanations.

Building on these contributions, I propose an accessible tutorial that revisits the programming language and defect proneness debate as a worked example, demonstrating that explicit causal credibility assessments can serve as both a diagnostic tool for evaluating existing research and a principled design guide for future studies.
