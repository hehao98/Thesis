...
Building on these contributions, I propose to show that studies employing an explicit framework and vocabulary for assessing causal credibility yield more trustworthy findings than those that rely solely on descriptive or correlational evidence without explicit causal reasoning.
