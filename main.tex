...
Unfortunately, empirical software engineering research often fails to rigorously test these beliefs when it relies on descriptive, correlational, and qualitative evidence without explicitly discussing the extent to which it can credibly support a causal theory of interest.
...
Across three empirical studies, I demonstrate how this approach more credibly reveals systematic gaps between practitioner beliefs and empirical reality. 
...
Finally, using a difference-in-differences framework with staggered adoption, I challenge the myth that AI coding tools unambiguously improve developer productivity, finding that Cursor's initial velocity gains are offset by sustained accumulation of technical debt.
In each study, I assess the credibility of causal claims through: (1) articulating the causal theory, (2) discussing the assumptions under which the findings carry a causal interpretation, (3) honestly acknowledging and mitigating limitations, and (4) carefully navigating alternative explanations.

Building on these contributions, I propose revisiting the programming language and defect proneness debate and show that this explicit framework and vocabulary for assessing causal credibility can serve as both a diagnostic tool for evaluating existing research and a principled design guide for future studies to better dispel longstanding software engineering myths.
...
\chapter{A Primer on Causal Credibility}
