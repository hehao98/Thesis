...
In the npm ecosystem, it means to not only use but also \emph{commit} the \Code{package-lock.json} file (Section~\ref{sec:background}) to the version control repository (44.21\% of GitHub repositories in our dataset did this).
