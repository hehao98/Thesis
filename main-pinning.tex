...
\paragraph{Summary of Our Contributions.} This study contributes novel quantitative evidence on the security and maintenance impact of version constraints in a packaging ecosystem, especially in light of recent concerns about malicious package updates.
...
We modified version constraints in the original file to illustrate different types of version constraints defined in Section~\ref{sec:method-rq1}. Other details irrelevant to this study are omitted.}
...
In this study, all outcome metrics are estimated from the conservative case of no manual developer actions; we leave the exploration of other cases to future work.
...
In this study, we have presented a counterfactual analysis and simulation study on the impact of version constraints in the npm ecosystem.
